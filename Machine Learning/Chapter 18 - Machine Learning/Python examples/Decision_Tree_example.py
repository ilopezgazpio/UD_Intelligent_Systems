...
entropy = -1e-100*log2(1e-100) - 1.00*log2(1.00)
print(entropy)
...
url = "https://raw.githubusercontent.com/lgazpio/UD_Intelligent_Systems/master/Machine%20Learning/Chapter%2018%20-%20Machine%20Learning/Python%20examples/agaricus-lepiota.csv"
