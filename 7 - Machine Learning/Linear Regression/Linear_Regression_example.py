...
# The problem with equation systems is that we can not always compute # (X_T X)^-1, because not all matrices are invertible
# This is why we need other methods to train weights, such as: backpropagation

#---------------------------------------------------------------------------
# PART 3: Linear Regression
#---------------------------------------------------------------------------
# Linear regression is a model in the way y_hat = w1 * x + w0
...
# The key is to "obtain" the right parameters

#---------------------------------------------------------------------------
# PART 4: Coefficients adjustments
#---------------------------------------------------------------------------
# Define weights for the learning hypotesis and alpha (usually random)
weights0 = np.array((0,0))
alpha = 0.01

# Calculate the predictions using current weights and current error
predicted = np.dot( trainingSetBias , weights0)
delta_error = target - predicted

# Update weigths (full batch)
...
#---------------------------------------------------------------------------
# PART 5: Coefficients adjustments (more complex hypothesis)
#---------------------------------------------------------------------------
