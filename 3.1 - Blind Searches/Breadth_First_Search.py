...
blind_bfs_tree_agent.final_node.depth
blind_bfs_tree_agent.final_node.action_history
blind_bfs_tree_agent.final_node.observation
blind_bfs_tree_agent.final_node.env.render()
# etc

# we can also analyze the search process using the reporting class inside the agent
blind_bfs_tree_agent.reporting.log
blind_bfs_tree_agent.reporting.plotNumberNodesFrontier()
blind_bfs_tree_agent.reporting.plotFrontierMaxDepth()
blind_bfs_tree_agent.reporting.plotNodesAddedFrontier(nbins=10)
...
# If solution is found we can explore the solution :)
blind_bfs_graph_agent.final_node.depth
blind_bfs_graph_agent.final_node.action_history
blind_bfs_graph_agent.final_node.observation
blind_bfs_graph_agent.final_node.env.render()

# we can also analyze the search process using the reporting class inside the agent
blind_bfs_graph_agent.reporting.log
blind_bfs_graph_agent.reporting.plotNumberNodesFrontier()
blind_bfs_graph_agent.reporting.plotFrontierMaxDepth()
blind_bfs_graph_agent.reporting.plotNodesAddedFrontier(nbins=10)
...
NumberNodesFrontier = pd.concat(
    [
       blind_bfs_tree_agent.reporting.log['Frontier'],
       blind_bfs_graph_agent.reporting.log['Frontier']
    ] , axis=1
)
...
MaxDepth = pd.concat(
    [
       blind_bfs_tree_agent.reporting.log['F.Max.Depth'],
       blind_bfs_graph_agent.reporting.log['F.Max.Depth']
    ] , axis=1
)
...
Expanded = pd.concat(
    [
       blind_bfs_tree_agent.reporting.log['Expanded'],
       blind_bfs_graph_agent.reporting.log['Expanded']
    ] , axis=1
)
...
blind_bfs_tree_agent = Blind_BFS_Tree_Agent()
blind_bfs_tree_agent.blind_search(first_node, 2500)
...
blind_bfs_graph_agent = Blind_BFS_Graph_Agent()
blind_bfs_graph_agent.blind_search(first_node, 2500)
