...
learning_rate = 0.001
num_episodes = 500 # Reduce for quick win / augment for stable results (more smoothed convergence)
gamma = 0.9999 # set to 1 for quick win
hidden_layer = 64
...
class NeuralNetwork(nn.Module):
    ...
    def forward(self, x):
        # add extra hidden layer for quick win
...
class QNet_Agent(object):
    ...
    def optimize(self):
        ...
        if double_dqn:
            ...
            # ...[0] gives access to values and [1] to
