...
# Output
directory = './BoxingVideos/'
env = gym.wrappers.Monitor(env, directory, video_callable=lambda episode_id: episode_id%5==0)
...
def plot_results():
    ...
    plt.savefig("Boxing-results.png")
    plt.close()
